...
class FragmentTrend : Fragment(), DataEvent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // check which items are trend and add them to dataSet
        data.map { item ->
            if (item.isTrend) {
                dataSet.add(item)
            }
